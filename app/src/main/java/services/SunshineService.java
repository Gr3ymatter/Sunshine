...
import com.gr3ymatter.sunshine.app.ForecastFragment;
...
public class SunshineService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String locationQuery = intent.getStringExtra(ForecastFragment.LOCATION_STRING);
