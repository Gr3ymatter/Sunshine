package com.gr3ymatter.sunshine.app.sync;
...
import com.gr3ymatter.sunshine.app.MainActivity;
import com.gr3ymatter.sunshine.app.R;
import com.gr3ymatter.sunshine.app.Utility;
...
// 60 seconds (1 minute) * 180 = 3 hours
    ...
    private void notifyWeather() {
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            if (cursor.moveToFirst()) {
                ...
                Intent sunshineIntent = new Intent(context, MainActivity.class);

                android.support.v4.app.TaskStackBuilder stackBuilder = android.support.v4.app.TaskStackBuilder.create(context);
                stackBuilder.addParentStack(MainActivity.class);
                stackBuilder.addNextIntent(sunshineIntent);

                PendingIntent sunshinePendingIntent = stackBuilder.getPendingIntent(0,  PendingIntent.FLAG_UPDATE_CURRENT);
                mBuilder.setContentIntent(sunshinePendingIntent);
    ...
    public static void syncImmediately(Context context) {
        ...
        Log.d("SyncAdapter", "SyncAdapter Called");
